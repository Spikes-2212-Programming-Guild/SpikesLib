...
public class DriveHolonomic extends Command {
	...
	private Supplier<Double> speedYSupplier, speedXSupplier, truningSpeedSupplier;
	...
	public DriveHolonomic(HolonomicDrivetrain drivetrain, Supplier<Double> speedYSupplier,
		...
		this.truningSpeedSupplier = truningSpeedSupplier;
	...
	protected void execute() {
		holonomicDrivetrain.holonomicDrive(speedYSupplier.get(), speedXSupplier.get(), truningSpeedSupplier.get());
