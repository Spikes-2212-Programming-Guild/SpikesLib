...
public class DriveArcadeWithTwoPIDControllers extends Command {
	...
	protected void initialize() {
		forwardMovementControl = new PIDController(forwardPIDSettings.getKP(), forwardPIDSettings.getKI(), forwardPIDSettings.getKD(), forwardSource,
				(PIDOutput)->forwardSpeed=PIDOutput);
	...
	new DriveArcade(this.drivetrain,forwardSpeed,rotationSpeed);
