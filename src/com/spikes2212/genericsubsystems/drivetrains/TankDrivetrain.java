...
public class TankDrivetrain extends Subsystem {
	...
	/**
	 * Moves both sides of this drivetrain given speeds for each side.
	 * 
	 * @param speedLeft
	...
	/**
	 * Moves the left side of this drivetrain with a given speed.
	 *
	 * @param speedLeft
	 *            the speed to set to the left side. Positive values move forward.
	 */
	...
	/**
	 * Initialize the default command for a subsystem.<br>
	 * By default, subsystems have no default command.<br>
	 * 
	 * @see {@link #setDefaultCommand(Command)}
	 */
	@Override // Does this have to be here?
