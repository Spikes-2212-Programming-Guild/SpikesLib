...
public class HolonomicDrivetrain extends TankDrivetrain {
	...
	public HolonomicDrivetrain(Consumer<Double> controlLeft, Consumer<Double> controlRight, Command defaultCommand,
			Consumer<Double> controlX, Consumer<Double> controlY) {
