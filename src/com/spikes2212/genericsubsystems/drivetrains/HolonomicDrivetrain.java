...
public abstract class HolonomicDrivetrain extends TankDrivetrain {
	...
	/**
	 * @param speedY the speed meant for the backward and forward movement of the drive system
	 * @param speedX the speed meant for the right and left movement of the drive system
	 */
