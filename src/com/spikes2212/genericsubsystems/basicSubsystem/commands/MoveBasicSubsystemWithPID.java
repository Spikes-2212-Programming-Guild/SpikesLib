...
public class MoveBasicSubsystemWithPID extends Command {
	 ...
	 * 
	 *            <p>
	 *            This command will try to move {@link MoveBasicSubsystemWithPID#subsystem} until it reaches the
	 ...
	 *      "http://first.wpi.edu/FRC/roborio/release/docs/java/edu/wpi/first/wpilibj/PIDController.html">PIDController</a>
	 */
	public MoveBasicSubsystemWithPID(BasicSubsystem subsystem, PIDSource source, Supplier<Double> setpoint,
	 ...
	 * 
	 *            <p>
	 *            This command will try to move the {@link MoveBasicSubsystemWithPID#subsystem} until it reaches the
	 ...
	 *      "http://first.wpi.edu/FRC/roborio/release/docs/java/edu/wpi/first/wpilibj/PIDController.html">PIDController</a>
	 */
	public MoveBasicSubsystemWithPID(BasicSubsystem subsystem, PIDSource source, double setpoint,
									 PIDSettings PIDSettings) {
		this(subsystem, source, () -> setpoint, PIDSettings);
	}
