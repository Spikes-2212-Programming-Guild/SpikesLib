...
public class PIDSettings {
     ...
     * @param waitTime  the time this PID loop will wait while within tolerance of the
     ...
     * tolerance for the amount of time specified by {@link #setWaitTime(Supplier<Double>)}.
     *
     * @param tolerance the new tolerance to set.
     */
     ...
     * {@link PIDSettings}.
     *
     * @param KD the new Differential coefficient.
     */
